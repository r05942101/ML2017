...
def main():
    ...
    pickle.dump(tokenizer, open('RNN.sav', 'wb'))
    ...
    pickle.dump(embedding_matrix, open('embedding_matrix.sav', 'wb'))
    #pickle.dump(tokenizer, open('RNN.sav', 'wb'))
   ...
   # model.add(Dropout(0.5))
    ...
    earlystopping = EarlyStopping(monitor='val_f1_score', patience = 12, verbose=1, mode='max')
    checkpoint = ModelCheckpoint(filepath='best_RNN.hdf5',
                                 verbose=1,
                                 save_best_only=True,
